...
const buttonOlustur = document.querySelector(".btn-container");
const menuOlustur = document.querySelector(".section-center");
...
`
buttonOlustur.innerHTML = allButtons;
}
createButtons();
...
const listAllFoods = () => {
  ...
  menuOlustur.innerHTML = allFoods;
}
...
const listKoreaFoods = () => {
  ...
  menuOlustur.innerHTML = koreaFoods;
}
...
const ListJapanFoods = () => {
  ...
  menuOlustur.innerHTML = JapanFoods;
}
...
const listChinaFoods =() => {
  ...
  menuOlustur.innerHTML = chinaFoods;
}
